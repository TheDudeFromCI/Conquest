...
public class Road extends Building implements Reshapeable{
	public Road(Chunk nwc, Kingdom kingdom){ super(nwc, kingdom, new BuildingTexture()); }
	public Road(Kingdom kingdom, String code, Chunk nwc, long id){ super(kingdom, code, nwc, id); }
	@Override
	...
	public boolean connectsTo(BuildingType type){
		if(type==BuildingType.TRADE_ROUTE)return false;
		if(type==BuildingType.CAPITOL)return true;
		return type.needsRoad();
	}
	public void updateGraphics(boolean threadsleep){
		...
		ConquestTextures.getTexture(BuildingType.ROAD, BuildingType.ROAD.getGraphicsLevelFor(form, lvl)).buildAt(nwc, Road.this);
	}
	public String[] getInfo(){
		if(WhCommunity.debug)WhCommunity.printDebug();
		String[] s = new String[13];
		s[0]=ChatColor.DARK_GRAY+"=================================";
		s[1]=ChatColor.DARK_AQUA+"Building Name .......... "+ChatColor.GRAY+"Road";
