...
public class Moat extends Building implements Reshapeable{
	public Moat(Chunk nwc, Kingdom kingdom){
		super(nwc, kingdom);
	}
	public Moat(Kingdom kingdom, String code, Chunk nwc, long id){
	...
	public void updateGraphics(boolean threadsleep){
		...
		ConquestTextures.getTexture(BuildingType.MOAT, BuildingType.MOAT.getGraphicsLevelFor(form, lvl)).buildAt(nwc, this);
	}
	public String[] getInfo(){
		if(WhCommunity.debug)WhCommunity.printDebug();
		String[] s = new String[13];
		s[0]=ChatColor.DARK_GRAY+"=================================";
		s[1]=ChatColor.DARK_AQUA+"Building Name .......... "+ChatColor.GRAY+"Moat";
	...
	public boolean connectsTo(BuildingType type){ return type==BuildingType.MOAT; }
	public int getHeightVariance(){ return 0; }
}