...
public class Cottage extends Building implements VillagerHoldable{
	public Cottage(Chunk NWcourner, Kingdom kingdom){
		super(NWcourner, kingdom);
		if(WhCommunity.debug)WhCommunity.printDebug();
	}
	public Cottage(Kingdom kingdom, String code, Chunk nwc, long id){
	...
	public String[] getInfo(){
		...
		s[1]=ChatColor.DARK_AQUA+"Building Name .......... "+ChatColor.GRAY+"Cottage";
		...
		s[8]=ChatColor.DARK_AQUA+"Type of Building ....... "+ChatColor.GRAY+"Dwelling";
		s[9]=ChatColor.DARK_AQUA+"Upgrade Cost ........... "+getUpgradeCostAsString();
		s[10]=ChatColor.DARK_AQUA+"Villagers Storage ...... "+ChatColor.AQUA+"+"+getVillagerMaxBonus()+ChatColor.GRAY+" Villager Max";
