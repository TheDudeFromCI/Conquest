...
public class StoneQuarry extends Building implements ResourceHolder, VillagerWorkable{
	private int stone;
	private int workers;
	public StoneQuarry(Chunk nwc, Kingdom kingdom){
		super(nwc, kingdom);
		if(WhCommunity.debug)WhCommunity.printDebug();
	}
	public StoneQuarry(Kingdom kingdom, String code, Chunk nwc, long id){
	...
	public void loadSaveStats(String code){
		...
		this.stone=Integer.valueOf(s[4]);
	...
	public double[] getResourcePercents(){
		if(WhCommunity.debug)WhCommunity.printDebug();
		return new double[]{stone/(double)getMaxResourceLevel()};
	}
	...
	public String[] getInfo(){
		...
		s[1]=ChatColor.DARK_AQUA+"Building Name .......... "+ChatColor.GRAY+"StoneQuarry";
