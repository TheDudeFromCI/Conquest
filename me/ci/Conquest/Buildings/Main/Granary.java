...
public class Granary extends Building implements ResourceHolder, VillagerWorkable{
	private int food;
	private int workers;
	private boolean rats;
	public Granary(Chunk nwc, Kingdom kingdom){
		super(nwc, kingdom);
		if(WhCommunity.debug)WhCommunity.printDebug();
	}
	public Granary(Kingdom kingdom, String code, Chunk nwc, long id){
	...
	public void loadSaveStats(String code){
		...
		this.food=Integer.valueOf(s[4]);
		this.workers=Integer.valueOf(s[5]);
		this.rats=Boolean.valueOf(s[6]);
	}
	...
	public double[] getResourcePercents(){
		if(WhCommunity.debug)WhCommunity.printDebug();
		return new double[]{food/(double)getMaxResourceLevel()};
	}
	public void setResource(ResourceType type, int amount){
		if(WhCommunity.debug)WhCommunity.printDebug();
		if(type==ResourceType.FOOD)food=amount;
	}
	public int getResourceLevel(ResourceType type){
		if(WhCommunity.debug)WhCommunity.printDebug();
		if(type==ResourceType.FOOD)return food;
		return 0;
	}
	...
	public String[] getInfo(){
		...
		s[1]=ChatColor.DARK_AQUA+"Building Name .......... "+ChatColor.GRAY+"Granary";
		...
		s[14]=ChatColor.DARK_AQUA+"Rats ................... "+ChatColor.GRAY+(rats?"Yes":"No");
		s[15]=ChatColor.DARK_GRAY+"=================================";
		return s;
	}
	public boolean hasRats(){ return rats; }
	public void freeRats(){ rats=true; }
}