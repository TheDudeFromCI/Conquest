...
public class Console extends JFrame{
	...
	public Console(){
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Console.class.getResource("/me/ci/Resources/Spiral Logo.png")));
	...
	public static void log(final LogType type, final Log log){
		...
		if(logs.containsKey(type))l=logs.get(type);
	...
	public static void save(){ for(LogType type : logs.keySet()){ for(Log l : logs.get(type)){ Save.set("Resources", "Log", type.getId()+"-"+logs.get(type).indexOf(l), l.save()); } } }
}