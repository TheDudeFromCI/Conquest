...
public class DruidsHallow extends Building implements TroopConvertable
{
	...
	public DruidsHallow(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public DruidsHallow(Kingdom kingdom, String code, Chunk nwc, long id)
	{
