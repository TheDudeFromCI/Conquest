...
public class WaterTemple extends Building implements TroopConvertable
{
	...
	public WaterTemple(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public WaterTemple(Kingdom kingdom, String code, Chunk nwc, long id)
	{
