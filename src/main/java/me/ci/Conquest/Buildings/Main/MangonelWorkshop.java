...
public class MangonelWorkshop extends Building implements TroopConvertable
{
	...
	public MangonelWorkshop(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public MangonelWorkshop(Kingdom kingdom, String code, Chunk nwc, long id)
	{
