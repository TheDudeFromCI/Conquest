...
public class TrebuchetWorkshop extends Building implements TroopConvertable
{
	...
	public TrebuchetWorkshop(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public TrebuchetWorkshop(Kingdom kingdom, String code, Chunk nwc, long id)
	{
