...
public class Graveyard extends Building implements TroopConvertable
{
	...
	public Graveyard(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public Graveyard(Kingdom kingdom, String code, Chunk nwc, long id)
	{
