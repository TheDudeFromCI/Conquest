...
public class WindTemple extends Building implements TroopConvertable
{
	...
	public WindTemple(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public WindTemple(Kingdom kingdom, String code, Chunk nwc, long id)
	{
