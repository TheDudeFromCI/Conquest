...
public class Church extends Building implements TroopConvertable
{
	...
	public Church(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public Church(Kingdom kingdom, String code, Chunk nwc, long id)
	{
