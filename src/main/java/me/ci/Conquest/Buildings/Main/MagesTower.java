...
public class MagesTower extends Building implements TroopConvertable
{
	...
	public MagesTower(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public MagesTower(Kingdom kingdom, String code, Chunk nwc, long id)
	{
