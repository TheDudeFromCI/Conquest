...
public class MeadHall extends Building implements TroopConvertable
{
	...
	public MeadHall(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public MeadHall(Kingdom kingdom, String code, Chunk nwc, long id)
	{
