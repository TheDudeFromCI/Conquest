...
public class Coliseum extends Building implements TroopConvertable
{
	...
	public Coliseum(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public Coliseum(Kingdom kingdom, String code, Chunk nwc, long id)
	{
