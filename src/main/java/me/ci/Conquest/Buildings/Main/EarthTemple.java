...
public class EarthTemple extends Building implements TroopConvertable
{
	...
	public EarthTemple(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public EarthTemple(Kingdom kingdom, String code, Chunk nwc, long id)
	{
