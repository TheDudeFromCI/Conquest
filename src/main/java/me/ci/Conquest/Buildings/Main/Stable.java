...
public class Stable extends Building implements TroopConvertable
{
	...
	public Stable(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public Stable(Kingdom kingdom, String code, Chunk nwc, long id)
	{
