...
public class AncientDojo extends Building implements TroopConvertable
{
	...
	public AncientDojo(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public AncientDojo(Kingdom kingdom, String code, Chunk nwc, long id)
	{
