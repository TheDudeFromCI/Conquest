...
public class BallisticWorkshop extends Building implements TroopConvertable
{
	...
	public BallisticWorkshop(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public BallisticWorkshop(Kingdom kingdom, String code, Chunk nwc, long id)
	{
