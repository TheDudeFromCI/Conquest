...
public class AntiMagicOnagerWorkshop extends Building implements TroopConvertable
{
	...
	public AntiMagicOnagerWorkshop(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public AntiMagicOnagerWorkshop(Kingdom kingdom, String code, Chunk nwc, long id)
	{
	...
	{
		return ArmyType.ANTIMAGIC_ONAGER;
	}
		...
		for (int x = 0; x < 16; x++)
		{
			for (int z = 0; z < 16; z++)
			{
				if (x == 0 || x == 15 || z == 0 || z == 15)
					to	.getBlock(x, PlotMg	.getPlotAt(nwc)
											.getHeight()
								+ 3, z)
