...
public class NobleManor extends Building implements TroopConvertable
{
	...
	public NobleManor(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public NobleManor(Kingdom kingdom, String code, Chunk nwc, long id)
	{
