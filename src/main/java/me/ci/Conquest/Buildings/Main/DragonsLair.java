...
public class DragonsLair extends Building implements TroopConvertable
{
	...
	public DragonsLair(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public DragonsLair(Kingdom kingdom, String code, Chunk nwc, long id)
	{
