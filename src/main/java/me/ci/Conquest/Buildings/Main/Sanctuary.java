...
public class Sanctuary extends Building implements TroopConvertable
{
	...
	public Sanctuary(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public Sanctuary(Kingdom kingdom, String code, Chunk nwc, long id)
	{
