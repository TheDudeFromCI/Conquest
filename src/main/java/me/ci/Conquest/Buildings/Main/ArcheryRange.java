...
public class ArcheryRange extends Building implements TroopConvertable
{
	...
	public ArcheryRange(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public ArcheryRange(Kingdom kingdom, String code, Chunk nwc, long id)
	{
