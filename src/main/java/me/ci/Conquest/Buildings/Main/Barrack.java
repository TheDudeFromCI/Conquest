...
public class Barrack extends Building implements TroopConvertable
{
	...
	public Barrack(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public Barrack(Kingdom kingdom, String code, Chunk nwc, long id)
	{
