...
public class FireTemple extends Building implements TroopConvertable
{
	...
	public FireTemple(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public FireTemple(Kingdom kingdom, String code, Chunk nwc, long id)
	{
