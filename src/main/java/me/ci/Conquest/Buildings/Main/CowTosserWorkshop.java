...
public class CowTosserWorkshop extends Building implements TroopConvertable
{
	...
	public CowTosserWorkshop(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public CowTosserWorkshop(Kingdom kingdom, String code, Chunk nwc, long id)
	{
