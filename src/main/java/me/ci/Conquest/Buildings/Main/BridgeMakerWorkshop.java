...
public class BridgeMakerWorkshop extends Building implements TroopConvertable
{
	...
	public BridgeMakerWorkshop(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public BridgeMakerWorkshop(Kingdom kingdom, String code, Chunk nwc, long id)
	{
