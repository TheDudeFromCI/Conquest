...
public class IllusionistsTower extends Building implements TroopConvertable
{
	...
	public IllusionistsTower(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public IllusionistsTower(Kingdom kingdom, String code, Chunk nwc, long id)
	{
