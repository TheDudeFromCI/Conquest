...
public class MilitaryFort extends Building implements TroopConvertable
{
	...
	public MilitaryFort(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public MilitaryFort(Kingdom kingdom, String code, Chunk nwc, long id)
	{
