...
public class DragonPit extends Building implements TroopConvertable
{
	...
	public DragonPit(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public DragonPit(Kingdom kingdom, String code, Chunk nwc, long id)
	{
