...
public class HolyBattlefield extends Building implements TroopConvertable
{
	...
	public HolyBattlefield(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public HolyBattlefield(Kingdom kingdom, String code, Chunk nwc, long id)
	{
