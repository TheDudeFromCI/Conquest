...
public class PortalGate extends Building implements TroopConvertable
{
	...
	public PortalGate(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public PortalGate(Kingdom kingdom, String code, Chunk nwc, long id)
	{
