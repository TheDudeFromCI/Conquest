...
public class CatapultWorkshop extends Building implements TroopConvertable
{
	...
	public CatapultWorkshop(Chunk nwc, Kingdom kingdom)
	{
		super(nwc, kingdom);
	...
	public CatapultWorkshop(Kingdom kingdom, String code, Chunk nwc, long id)
	{
