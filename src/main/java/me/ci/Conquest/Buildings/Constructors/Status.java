...
public class Status
{
	...
	public Status(Building building, StatusType type, byte damage)
	{
		...
		STATUS_LEVEL += PlotMg	.getPlotAt(chunk)
								.getHeight();
	}
	...
	private void drawBuilding()
	{
		if (building instanceof Army)
		{
			...
			int mx = building	.getNorthWestCourner()
								.getBlock(0, 0, 0)
								.getX();
			int mz = building	.getNorthWestCourner()
								.getBlock(0, 0, 0)
								.getZ();
			for (int x = 0; x < 16; x++)
			{
				for (int z = 0; z < 16; z++)
				{
					...
					{
						if (mx + x == getStartX() || mx + x == getEndX() || mz + z == getStartZ()
								|| mz + z == getEndZ())
							army.getWorld()
								.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
								// .setTypeIdAndData(35, this.type.getColor(), true);
					...
					{
						if ((mx + x == getStartX() || mx + x == getEndX())
								&& (mz + z == getStartZ() || mz + z == getEndZ()))
						{
							army.getWorld()
								.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
								// .setTypeIdAndData(35, (byte) 0, true);
								.setType(Material.WHITE_WOOL);
						}
						else if (mx + x == getStartX())
						{
							if (form.usesSide(Direction.WEST))
								this.building	.getWorld()
												.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
												// .setTypeIdAndData(35, (byte) 14, true);
												.setType(Material.WHITE_WOOL);
							else
								army.getWorld()
									.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
						...
						{
							if (form.usesSide(Direction.NORTH))
								this.building	.getWorld()
												.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
												// .setTypeIdAndData(35, (byte) 14, true);
												.setType(Material.WHITE_WOOL);
						...
						{
							if (form.usesSide(Direction.SOUTH))
								this.building	.getWorld()
												.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
												// .setTypeIdAndData(35, (byte) 14, true);
												.setType(Material.WHITE_WOOL);
							...
							army.getWorld()
								.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
								// .setTypeIdAndData(type.getMaterialId(), type.getData(), true);
								.setType(Material.WHITE_WOOL);
					}
				}
			}
			...
			{
				army.getWorld()
					.getBlockAt(mx + 2, STATUS_LEVEL, mz + 2)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 2, STATUS_LEVEL, mz + 3)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 3, STATUS_LEVEL, mz + 2)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 12, STATUS_LEVEL, mz + 2)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 13, STATUS_LEVEL, mz + 2)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 13, STATUS_LEVEL, mz + 3)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 2, STATUS_LEVEL, mz + 12)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 2, STATUS_LEVEL, mz + 13)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 3, STATUS_LEVEL, mz + 13)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 12, STATUS_LEVEL, mz + 13)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 13, STATUS_LEVEL, mz + 12)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
				army.getWorld()
					.getBlockAt(mx + 13, STATUS_LEVEL, mz + 13)
					// .setTypeIdAndData(35, (byte) 4, true);
					.setType(Material.WHITE_WOOL);
			}
			for (int x = 0; x < 16; x++)
			{
				for (int z = 0; z < 16; z++)
				{
					if (((1 <= x && x <= 14) && (1 == z || z == 14)) || ((1 == x || x == 14) && (1 <= z && z <= 14)))
					{
								...
								|| (x == 2 && z == 1 && percent > 1.923076923076923 * 51))
						{
							if (!army.isNullified())
								army.getWorld()
									.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
									// .setTypeIdAndData(35, (byte) 11, true);
									.setType(Material.WHITE_WOOL);
							else
								this.building	.getWorld()
												.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
												// .setTypeIdAndData(35, (byte) 7, true);
												.setType(Material.WHITE_WOOL);
						}
						else
						{
							if (!army.isNullified())
								army.getWorld()
									.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
									// .setTypeIdAndData(35, (byte) 3, true);
									.setType(Material.WHITE_WOOL);
							else
								this.building	.getWorld()
												.getBlockAt(mx + x, STATUS_LEVEL, mz + z)
												// .setTypeIdAndData(35, (byte) 8, true);
												.setType(Material.WHITE_WOOL);
						}
					}
				}
			}
			final int range = army	.getArmyType()
									.getRange();
			final int used = (int) (army.isAttacking() && army	.canAttack()
																.equals("Yes") ? army.getDistance(army.getTarget())
																		: 0);
			...
			{
				basex = army.getNorthWestCourner()
							.getBlock(3, 0, 0)
							.getX();
				basez = army.getNorthWestCourner()
							.getBlock(3, 0, 0)
							.getZ();
			}
			...
			for (int i = 0; i < 10; i++)
			{
				...
				if (i < used)
					...
					c = (byte) 0;
				army.getWorld()
					.getBlockAt(x, STATUS_LEVEL + 5, z)
					// .setTypeIdAndData(35, c, true);
					.setType(Material.WHITE_WOOL);
			}
			for (int i = 0; i < 10; i++)
			{
		...
		else
		{
			for (int x = getStartX(); x <= getEndX(); x++)
			{
				...
				{
					if (x == getStartX() || x == getEndX() || z == getStartZ() || z == getEndZ())
						this.building	.getWorld()
										.getBlockAt(x, STATUS_LEVEL, z)
										// .setTypeIdAndData(35, this.type.getColor(), true);
										.setType(Material.WHITE_WOOL);
				}
			}
	...
	private void drawHealth()
	{
		...
		{
			// Courner 1
			Block b = this.building	.getWorld()
									.getBlockAt(getStartX(), STATUS_LEVEL, getStartZ());
			...
			// Courner 2
			b = this.building	.getWorld()
								.getBlockAt(getStartX(), STATUS_LEVEL, getEndZ());
			b.setType(Material.NETHERRACK);
			b	.getRelative(BlockFace.UP)
				.setType(Material.FIRE);
			distance = 1;
			...
			// Courner 3
			b = this.building	.getWorld()
								.getBlockAt(getEndX(), STATUS_LEVEL, getStartZ());
			b.setType(Material.NETHERRACK);
			b	.getRelative(BlockFace.UP)
				.setType(Material.FIRE);
			distance = 1;
			...
			// Courner 4
			b = this.building	.getWorld()
								.getBlockAt(getEndX(), STATUS_LEVEL, getEndZ());
			b.setType(Material.NETHERRACK);
			b	.getRelative(BlockFace.UP)
				.setType(Material.FIRE);
			distance = 1;
	...
	private int getStartX()
	{
		if (startx == 5)
		{
			if (this.building == null)
				startx = this.chunk	.getBlock(0, 0, 0)
									.getX();
			startx = this.building	.getNorthWestCourner()
									.getBlock(0, 0, 0)
									.getX();
		}
		return startx;
	...
	private int getEndX()
	{
		...
		{
			if (this.building == null)
				endx = this.chunk	.getBlock(15, 0, 0)
									.getX();
			endx = this.building.getSouthEastCourner()
								.getBlock(15, 0, 0)
								.getX();
		}
		return endx;
	...
	private int getStartZ()
	{
		...
		{
			if (this.building == null)
				startz = this.chunk	.getBlock(0, 0, 0)
									.getZ();
			startz = this.building	.getNorthWestCourner()
									.getBlock(0, 0, 0)
									.getZ();
		}
		return startz;
	...
	private int getEndZ()
	{
		...
		{
			if (this.building == null)
				endz = this.chunk	.getBlock(0, 0, 15)
									.getZ();
			endz = this.building.getSouthEastCourner()
								.getBlock(0, 0, 15)
								.getZ();
		}
		return endz;
